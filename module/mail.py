...
class EmailOSINT(JustradamusModule):
    ...
    def run_scan(self):
        console.print("[>] EMAIL OSINT SCANNER")
        console.print(f"Cible    : {self.email}")
        console.print(f"Username : {self.username}  |  Domaine : {self.domain}")
        console.print("-" * 40)
        ...
        console.print("-" * 40)
        console.print(f"[+] Trouvé    : {len(self.found)}")
        console.print(f"[!] Erreurs   : {len(self.errors)}")
        console.print(f"    Non trouvé: {len(self.not_found)}")
